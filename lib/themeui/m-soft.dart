...
class ImagePagesoft extends StatefulWidget {

    final Item item;
  const ImagePagesoft({Key? key, required this.item}) : super(key: key);

  @override
  _MySubPageState createState() => _MySubPageState();
}

class _MySubPageState extends State<ImagePagesoft> {
