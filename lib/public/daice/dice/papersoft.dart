...
class Papersoft extends StatefulWidget {
  const Papersoft({Key? key}) : super(key: key);

  @override
  State<Papersoft> createState() => _PaperState();
}

class _PaperState extends State<Papersoft>  with AutomaticKeepAliveClientMixin {
