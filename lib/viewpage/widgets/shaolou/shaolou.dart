...
class salo extends StatefulWidget {
      final Item item;
  ...
  @override
  State<salo> createState() => _SpinKitPouringHourGlassRefinedState();
}

class _SpinKitPouringHourGlassRefinedState extends State<salo>
