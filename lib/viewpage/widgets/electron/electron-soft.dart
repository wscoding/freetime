...
class Electronsoft extends StatefulWidget {

    final Item item;
  const Electronsoft({Key? key, required this.item}) : super(key: key);

  @override
  State<Electronsoft> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Electronsoft> {
